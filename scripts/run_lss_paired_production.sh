...
export SHIFT_USE_MATERIAL_AWARE_VERTEX_TRANSPORT=${SHIFT_USE_MATERIAL_AWARE_VERTEX_TRANSPORT:-0}
export SHIFT_USE_FORWARD_COMMON_VERTEX_FIT=${SHIFT_USE_FORWARD_COMMON_VERTEX_FIT:-0}
